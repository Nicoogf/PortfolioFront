...
import dashboard from "@/public/portadapizza.jpg" ;
import primerPortfolio from "@/public/portadapotfolio.jpg" ;
...
export const experiencesData = [
  ...
  {
    title: "JavaScript Algorithms and Data Structures | Finalizada",
    location: "FreeCodeCamp",
    description: " Resolucion de algoritmos y diseño de estructuras de datos para resolver problemas informáticos avanzados.",
    icon: React.createElement(FaReact),
    date: "2023",
  },
  {
...
export const projectsData = [
  {
    ...
    tags: ["JS Vanilla", "Tailwind"],
    imageUrl: landing,
    link: "https://nicoogf.github.io/landingpageproject/"
  }, 
  {
